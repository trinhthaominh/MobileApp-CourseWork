...
import com.example.bai11gridview.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        list.add(OutData(R.drawable.giatocrong,"Gia tộc rồng"))
        list.add(OutData(R.drawable.hoanhon,"Hoàn hồn"))
        list.add(OutData(R.drawable.thanlan,"Thằn lằn"))


        val customGridView = CustomGridView(this,list)

        binding.gvPhim.adapter = customGridView
